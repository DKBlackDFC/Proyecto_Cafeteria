 ...
 * @author DIEGO
 */
public class Alerta_Informacion extends javax.swing.JDialog {

    public Alerta_Informacion(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        addEventKey();
        initComponents();
    ...
    private void initComponents() {
        ...
        JPNL_Fondo.setBackground(new java.awt.Color(0, 153, 204));
        JPNL_Fondo.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 153, 204), 10));
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/IMG/Alertas/Icono_Atencion.png"))); // NOI18N
        ...
        JLBL_Titulo.setText("¡ Hey Atención !");

        JBTN_Salir.setBackground(new java.awt.Color(0, 153, 204));
        ...
        JBTN_Salir.setColorHover(new java.awt.Color(0, 153, 204));
        ...
        JPNL_FondoLayout.setHorizontalGroup(
            ...
            .addGroup(JPNL_FondoLayout.createSequentialGroup()
                ...
                .addGroup(JPNL_FondoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    .addComponent(JLBL_Mensaje2, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(JLBL_Mensaje1, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(JLBL_Mensaje3, javax.swing.GroupLayout.DEFAULT_SIZE, 330, Short.MAX_VALUE)
        ...
        rSPanelShadow1.add(JPNL_Fondo, java.awt.BorderLayout.CENTER);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Alerta_Informacion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Alerta_Informacion dialog = new Alerta_Informacion(new javax.swing.JFrame(), true);
